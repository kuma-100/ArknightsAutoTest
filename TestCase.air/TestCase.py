...
def CreditAccess():
    ...
    wait(Template(r"tpl1599124536167.png", record_pos=(-0.424, -0.133), resolution=(1440, 810)))
...
def FungiMist(cnt):
    for i in range(cnt):
        ...
        touch(Template(r"tpl1598677224290.png", threshold=0.9, record_pos=(0.174, 0.09), resolution=(2400, 1080)))
        wait(Template(r"tpl1598677242685.png", threshold=0.9, record_pos=(-0.449, -0.193), resolution=(2400, 1080)),timeout=100)
